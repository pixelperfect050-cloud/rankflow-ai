    ...
    <main className="flex-1 w-full bg-slate-50">
      ...
      <section className="relative overflow-hidden bg-white border-b border-slate-200">
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-24 md:py-32 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-100 text-blue-700 text-xs font-bold tracking-wider uppercase mb-8">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 tracking-tight mb-8 leading-[1.1]">
            ...
            for your <span className="text-blue-600">workflow.</span>
          </h1>
          ...
          <div className="max-w-2xl mx-auto flex flex-col sm:flex-row gap-4 justify-center">
            <div className="relative w-full max-w-lg">
              ...
              <input 
                ...
                className="w-full h-14 pl-12 pr-4 bg-white border-2 border-slate-200 rounded-xl text-slate-900 shadow-sm focus:border-blue-600 focus:ring-4 focus:ring-blue-50 transition-all outline-none text-lg"
              />
            </div>
            <button className="h-14 px-8 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold shadow-lg shadow-blue-200 transition-all whitespace-nowrap">
              Search
            </button>
          </div>
        </div>
      ...
      <section className="py-20 max-w-[1200px] mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between mb-10">
          ...
          <Link href="/products" className="hidden sm:flex items-center gap-2 text-blue-600 font-semibold hover:text-blue-700 transition-colors">
      ...
      <section className="py-24 bg-slate-100 text-slate-900">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 text-lg max-w-2xl mx-auto">Don't guess. See head-to-head data on pricing, features, and user reviews before you buy.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {[
              ...
              <Link key={comp.id} href={`/compare/${comp.slug}`} className="group relative p-8 bg-white rounded-2xl border border-slate-200 shadow-sm hover:border-blue-600 hover:shadow-md transition-all">
                <div className="flex items-center justify-between text-xl font-bold mb-4">
                  <span>{comp.p1}</span>
                  <span className="text-slate-500 text-sm px-2 bg-slate-100 rounded-full">VS</span>
                  <span>{comp.p2}</span>
                </div>
                <div className="text-blue-600 text-sm font-medium flex items-center gap-2 mt-6">
      ...
      <section className="py-24 bg-blue-600 text-center px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-blue-100 text-lg mb-10">Search our database of strictly verified software products and start building better today.</p>
          <button className="px-8 py-4 bg-white text-blue-900 rounded-xl font-bold text-lg hover:bg-slate-50 transition-colors shadow-xl">
